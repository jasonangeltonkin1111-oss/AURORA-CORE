...
def _board_text(summary: L21PublishSummary) -> str:
    return "\n".join([
        ...
        "Purpose: selected-symbol reference context only",
        "Merge Allowed: FALSE",
        ...
        "",
        "Phase 1: ATR, range percentile, MA slope, stddev, Bollinger, VWAP, spread-to-range",
        "Phase 2: RSI, ADX/DMI, Donchian, Choppiness, volume/tick-volume MA",
        "Phase 3: MACD, Stochastic, Keltner, Z-score, L19 candle-pressure reference only",
        "",
