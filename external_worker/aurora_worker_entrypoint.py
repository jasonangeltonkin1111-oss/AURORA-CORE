...
def _write_surface_epoch_if_accepted(root: Path, result: core.ValidationResult, enable_l13_runtime: bool, enable_l14_runtime: bool, enable_l15_runtime: bool) -> bool:
    ...
    l15_ok_states = {"accepted", "write_degraded", "degraded"}
    all_complete = (
        result.ok
        ...
        and ((l15_status in l15_ok_states) if enable_l15_runtime else True)
    )
    if not all_complete:
        return False
...
def _run_core_once_with_l11_l12_l13_l14(root: Path, worker_mode: str, enable_l13_runtime: bool = ENABLE_L13_RUNTIME, enable_l14_runtime: bool = ENABLE_L14_RUNTIME, enable_l15_runtime: bool = ENABLE_L15_RUNTIME) -> Tuple[int, core.ValidationResult]:
