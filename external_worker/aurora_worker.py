...
WORKER_VERSION = "0.6.15_l15_correlation_diversity"
...
def build_result(result: ValidationResult, rows: List[str], worker_mode: str) -> str:
    ...
    return "\n".join([
        ...
        "notes=r3_snapshot_validation_plus_l6_l7_l8_l9_l10_taxonomy_plus_render_index_no_layer5_advisory_no_selection_no_permission_no_broker_polling", ""
    ])
...
def build_result_manifest(result: ValidationResult, result_text: str) -> str:
    ...
    return "\n".join([
        ...
        "result_scope=r3_snapshot_validation_plus_l6_l7_l8_l9_l10_taxonomy_plus_render_index_no_layer5_advisory_no_selection_no_permission", f"generated_utc={utc_stamp()}", f"generated_unix={unix_time()}", ""
    ])
