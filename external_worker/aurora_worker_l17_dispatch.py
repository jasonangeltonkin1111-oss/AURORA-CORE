...
def l17_result_lines(summary: L17PublishSummary, duration_ms: int) -> str:
    return "\n".join([
        ...
        f"l17_source_l16_current_chain_valid={summary.source_l16_current_chain_valid}",
        f"l17_current_chain_valid={summary.latest_current}",
        f"l17_downstream_allowed={summary.downstream_allowed}",
        f"l17_visible_output_source={summary.visible_output_source}",
        f"l17_currentness_reason={summary.currentness_reason}",
