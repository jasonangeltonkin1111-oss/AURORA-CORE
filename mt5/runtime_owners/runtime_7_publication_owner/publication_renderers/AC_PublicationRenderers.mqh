...
static int    AC_SHARED_OHLC_TASKS_PER_SERVICE = 1;
static uint   AC_SHARED_OHLC_SERVICE_BUDGET_MS = 80;
static uint   AC_SHARED_OHLC_SERVICE_INTERVAL_MS = 1000;
