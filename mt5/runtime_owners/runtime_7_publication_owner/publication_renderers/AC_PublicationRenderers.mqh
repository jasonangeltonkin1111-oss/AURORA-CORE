...
// Shared OHLC Raw Storage active bridge.
// Source authority: Runtime 1 Shared OHLC Raw Storage Owner.
// Renderer surfaces may display status only; they do not own OHLC truth.
// This bridge stores raw MT5 bars only: no calculations, no ranking, no selection, no trade permission, no execution.
// Priority law: P1 open/pending -> P2 Layer 5 pass -> P3 explicit future candidate hook -> P4 other open -> P5 closed/blocked/unknown.

static string AC_SHARED_OHLC_STATUS = "seed_active";
static string AC_SHARED_OHLC_MODE = "priority_window_then_full_seed";
...
{
   if(AC_SHARED_OHLC_LAST_SERVICE_MS>500){ AC_SHARED_OHLC_ADAPTIVE_MODE="cooldown"; AC_SHARED_OHLC_TASKS_PER_SERVICE=1; AC_SHARED_OHLC_SERVICE_INTERVAL_MS=2000; AC_SHARED_OHLC_SERVICE_BUDGET_MS=80; AC_SHARED_OHLC_COOLDOWN_RUNS=10; AC_SHARED_OHLC_FAST_STREAK=0; return; }
   if(AC_SHARED_OHLC_COOLDOWN_RUNS>0){ AC_SHARED_OHLC_COOLDOWN_RUNS--; AC_SHARED_OHLC_ADAPTIVE_MODE="cooldown"; AC_SHARED_OHLC_TASKS_PER_SERVICE=1; AC_SHARED_OHLC_SERVICE_INTERVAL_MS=2000; AC_SHARED_OHLC_SERVICE_BUDGET_MS=80; return; }
   if(AC_SHARED_OHLC_LAST_SERVICE_MS>250){ AC_SHARED_OHLC_ADAPTIVE_MODE="protective"; AC_SHARED_OHLC_TASKS_PER_SERVICE=1; AC_SHARED_OHLC_SERVICE_INTERVAL_MS=1000; AC_SHARED_OHLC_SERVICE_BUDGET_MS=80; AC_SHARED_OHLC_FAST_STREAK=0; return; }
   if(AC_SHARED_OHLC_LAST_SERVICE_MS<80) AC_SHARED_OHLC_FAST_STREAK++; else AC_SHARED_OHLC_FAST_STREAK=0;
   if(AC_SHARED_OHLC_FAST_STREAK>=5){ AC_SHARED_OHLC_ADAPTIVE_MODE="fast"; AC_SHARED_OHLC_TASKS_PER_SERVICE=4; AC_SHARED_OHLC_SERVICE_INTERVAL_MS=250; AC_SHARED_OHLC_SERVICE_BUDGET_MS=120; return; }
   AC_SHARED_OHLC_ADAPTIVE_MODE="normal"; AC_SHARED_OHLC_TASKS_PER_SERVICE=2; AC_SHARED_OHLC_SERVICE_INTERVAL_MS=500; AC_SHARED_OHLC_SERVICE_BUDGET_MS=120;
}
