...
void AC_ExternalWorkerInitStatus()
{
   ...
   AC_EXTERNAL_WORKER_STATUS.install_flat_exe_runtime_authority = "not_available";
   AC_EXTERNAL_WORKER_STATUS.install_packaged_exe_runtime_authority = "not_available";
   AC_EXTERNAL_WORKER_STATUS.install_packaged_internal_python_dll_present = "not_available";
   ...
   AC_EXTERNAL_WORKER_STATUS.install_watchdog_method = "not_available";
   AC_EXTERNAL_WORKER_STATUS.install_watchdog_task_name = "not_available";
   AC_EXTERNAL_WORKER_STATUS.install_watchdog_task_registered = "not_available";
   AC_EXTERNAL_WORKER_STATUS.install_watchdog_task_state = "not_available";
   AC_EXTERNAL_WORKER_STATUS.install_watchdog_task_error = "not_available";
   AC_EXTERNAL_WORKER_STATUS.install_operator_cmd_required = "not_available";
   ...
   AC_EXTERNAL_WORKER_STATUS.lifecycle_last_job_id = "not_available";
   AC_EXTERNAL_WORKER_STATUS.lifecycle_last_job_type = "not_available";
   ...
   AC_EXTERNAL_WORKER_STATUS.heartbeat_job_bus_schema_version = "not_available";
   AC_EXTERNAL_WORKER_STATUS.heartbeat_job_id = "not_available";
   AC_EXTERNAL_WORKER_STATUS.heartbeat_job_type = "not_available";
   ...
   AC_EXTERNAL_WORKER_STATUS.result_job_bus_schema_version = "not_available";
   AC_EXTERNAL_WORKER_STATUS.result_job_id = "not_available";
   AC_EXTERNAL_WORKER_STATUS.result_job_type = "not_available";
   AC_EXTERNAL_WORKER_STATUS.result_job_resource_class = "not_available";
   AC_EXTERNAL_WORKER_STATUS.result_job_max_runtime_ms = "not_available";
   AC_EXTERNAL_WORKER_STATUS.result_job_status = "not_available";
   ...
   AC_EXTERNAL_WORKER_STATUS.job_bus_status = "Not checked";
   AC_EXTERNAL_WORKER_STATUS.job_bus_validation_status = "Not checked";
   AC_EXTERNAL_WORKER_STATUS.job_bus_validation_reason = "";
   AC_EXTERNAL_WORKER_STATUS.job_bus_expected_job_id = "not_available";
   AC_EXTERNAL_WORKER_STATUS.job_bus_expected_job_type = "not_available";
   AC_EXTERNAL_WORKER_STATUS.job_bus_expected_schema_version = "not_available";
   AC_EXTERNAL_WORKER_STATUS.job_bus_result_job_id = "not_available";
   AC_EXTERNAL_WORKER_STATUS.job_bus_result_job_type = "not_available";
   AC_EXTERNAL_WORKER_STATUS.job_bus_result_schema_version = "not_available";
