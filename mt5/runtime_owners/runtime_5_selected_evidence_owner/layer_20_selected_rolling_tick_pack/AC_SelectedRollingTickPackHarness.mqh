...
static const string AC_L20_HARNESS_STATUS_DISABLED = "not_wired_disabled_until_L1_L19_stable";
...
{
   // Compile-touch helper only. It references the L20 source and publication surfaces without running broker tick capture.
