...
static const string AC_UPGRADE_SCOPE      = "Stable Selection Desk parent routes, selection index placeholder, diagnostics, and documentation alignment only; no generated universe rows, no taxonomy runtime load, no ranking, no selection logic, no alerts, no strategy, no worker, and no trade execution.";
static const string AC_UPGRADE_TEST_PLAN  = "Compile AuroraCore.mq5; smoke Selection Desk/Groups, Selection Desk/Global, and Selection Desk/Selection Index.txt; verify rank/top numbering is not used in parent folder names and runtime_permission remains LOOKUP_ONLY_NOT_TRADE_PERMISSION.";
