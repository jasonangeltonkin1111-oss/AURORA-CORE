...
static const string AC_BUILD_PHASE        = "layer3_broker_metadata_diagnostics";
static const string AC_BUILD_VERSION      = "1.034";
static const string AC_UPGRADE_ID         = "L3_BROKER_METADATA_DIAGNOSTICS";
static const string AC_UPGRADE_SUMMARY    = "Adds Layer 3 broker metadata retrieval for ISIN, exchange, sector, industry, and country using broker symbol properties, with status lines that distinguish broker returned value, broker returned blank, and API failure.";
static const string AC_UPGRADE_SCOPE      = "Layer 0 cached universe publication plus Layer 1 account/portfolio report polish, Layer 2 market open/closed/unknown session truth, and Layer 3 broker specs/value/metadata diagnostics for Layer 2 known open and closed symbols. Unknown symbols may stop earlier. No Layer 4 live quote freshness, ranking, selection, alerts, strategy, Python worker, or trade execution.";
static const string AC_UPGRADE_TEST_PLAN  = "Compile AuroraCore.mq5; run EA; confirm Dossiers show ISIN/Exchange/Sector/Industry/Country plus status lines explaining broker API returned value, broker returned blank, or API failed. Confirm external links do not overwrite broker metadata or Runtime 2 taxonomy.";
static const string AC_LOGGING_POLICY     = "near_instant_board_write_if_changed_plus_l3_broker_metadata_diagnostics";
...
static const string AC_DOSSIER_SHELL_SCHEMA_VERSION = "dossier_v1.034_l3_broker_metadata_diagnostics";
