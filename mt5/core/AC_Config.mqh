...
static const string AC_BUILD_PHASE        = "layer1_report_polish_after_l3";
static const string AC_BUILD_VERSION      = "1.031";
static const string AC_UPGRADE_ID         = "L1_MT5_STYLE_REPORT_POLISH";
static const string AC_UPGRADE_SUMMARY    = "Polishes Layer 1 Board, Dossier, and Account Status into MT5-style portfolio reporting with trade duration, richer report metrics, and no visible reconstruction meta labels.";
static const string AC_UPGRADE_SCOPE      = "Layer 0 cached universe publication plus Layer 1 account/portfolio report polish, Layer 2 market open/closed/unknown session truth, and Layer 3 broker specs/value truth for Layer 2 open symbols. No Layer 4 live quote freshness, ranking, selection, alerts, strategy, Python worker, or trade execution.";
static const string AC_UPGRADE_TEST_PLAN  = "Compile AuroraCore.mq5; run EA; confirm Board, Dossiers, and Account Status show MT5-style Layer 1 metrics, per-trade duration, clean Win/Loss/Flat results, no LOSS_OK_SLTP_MISSING or core/order_ctx visible meta, Layer 3 sections visible, and no trade permission.";
...
static const string AC_DOSSIER_SHELL_SCHEMA_VERSION = "dossier_v1.031_l1_report_polish_l3_visible";
